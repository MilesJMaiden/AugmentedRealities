Shader "Meta/Depth/BiRP/EarthWandCircles"
{
    Properties
    {
        ...
        _invFresnelIntensity2 ("fresnel intensity", float) = 0
    }
    SubShader
    {
        ...
        Pass
        {
            ...
            half invFresnel(float3 worldNormal, float3 camDirection) {
                float fresnelVal = dot(worldNormal,camDirection);
                return saturate(fresnelVal+_invFresnelIntensity2);
            }
            ...
            half4 frag(Varyings input) : SV_Target
            {
                ...
                half invFresnelNum = invFresnel(input.worldNormal,camdirection);
                half4 fresnelAlpha = half4(1,1,1,fresnelNum);


                finalColor = fresnelNum + invFresnelNum;
